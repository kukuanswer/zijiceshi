...
public class SDLSurface extends SurfaceView implements SurfaceHolder.Callback,
	...
	// Startup
	public SDLSurface(Context context, int buffersize, int maxAnalyzeDuration, int full_screen_width, int full_screen_height) {
		super(context);
		this.full_screen_width = full_screen_width;
		this.full_screen_height = full_screen_height;
	...
	public void surfaceChanged(SurfaceHolder holder, int format, int width,
		...
		SDLActivity.onNativeResize(full_screen_width, full_screen_height, sdlFormat);
		Log.v("SDL", "Window size:" + width + "x" + height);
		SDLActivity.PlayerSetScreenParams(width, height);
		SDLActivity.startApp(buffersize, maxAnalyzeDuration);
	}
